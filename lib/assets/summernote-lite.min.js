                ...
                return e = t, (n = [{
                    ...
                    value: function(t, e) {
                        ...
                        return (n = t, i.a.Deferred((function(t) {
                            ...
                            o.context.triggerEvent("image.upload.error", src, t)
                        }))
                    }
                }, {
                    ...
                    value: function(t) {
                        ...
                        i.a.each(t, (function(t, n) {
                            var o = n.name;
                            e.options.maximumImageFileSize && e.options.maximumImageFileSize < n.size ? e.context.triggerEvent("image.upload.error", file, e.lang.image.maximumFileSizeError) : function(t) {
                                ...
                                e.context.triggerEvent("image.upload.error", file, "base64 failed")
                            }))
                        }))
                    }
                }, {
                ...
                return e = t, (n = [{
                    ...
                    value: function(t) {
                        ...
                        if (n && 11 === n[1].length) {
                            ...
                            e = i()("<iframe>").attr("frameborder", 0).attr("src", "https://www.youtube.com/embed/" + m + (v > 0 ? "?start=" + v : "")).attr("width", "640").attr("height", "360")
                        ...
                        else if (a && a[3].length) e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("src", "https://player.vimeo.com/video/" + a[3]).attr("width", "640").attr("height", "360");
                        else if (s && s[2].length) e = i()("<iframe>").attr("frameborder", 0).attr("src", "https://www.dailymotion.com/embed/video/" + s[2]).attr("width", "640").attr("height", "360");
                        else if (l && l[1].length) e = i()("<iframe webkitallowfullscreen mozallowfullscreen allowfullscreen>").attr("frameborder", 0).attr("height", "498").attr("width", "510").attr("src", "https://player.youku.com/embed/" + l[1]);
